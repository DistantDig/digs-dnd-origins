...
public class GreenBreathParticle extends SpriteBillboardParticle {
    private final SpriteProvider sprites;
    protected GreenBreathParticle(ClientWorld world, double x, double y, double z,
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType particleType, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            return new GreenBreathParticle(world, x, y, z, this.sprites, velocityX, velocityY, velocityZ);
        }
    }
}
