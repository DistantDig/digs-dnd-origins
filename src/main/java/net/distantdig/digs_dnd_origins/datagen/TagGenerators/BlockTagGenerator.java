...
public class BlockTagGenerator extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        ...
        getOrCreateTagBuilder(STONE_CAMOUFLAGE_BLOCKS)
                ...
                .addOptionalTag(new Identifier("c", "cobblestone"))
                .addOptionalTag(new Identifier("c", "end_stones"))
                .addOptionalTag(new Identifier("c", "natural_stones"))
                .addOptionalTag(new Identifier("c", "nether_stones"))
                .addOptionalTag(new Identifier("c", "netherrack"))
                .addOptionalTag(new Identifier("c", "ores"))
                .addOptionalTag(new Identifier("c", "sandstone"))
                .addOptionalTag(new Identifier("c", "stone"))
                .addOptionalTag(new Identifier("c", "terracotta"))
